  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={onGenerate} className="space-y-6">
        ...
        <section className="bg-[#18181b] rounded-xl border border-[#27272a] p-6 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-[#27272a] pb-4 mb-6 gap-3">
            ...
            <div className="flex items-center gap-2">
              {equipos.length > 0 && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/20 rounded-md text-xs font-semibold transition cursor-pointer"
                >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 bg-transparent border border-dashed border-[#3f3f46] text-[#a1a1aa] hover:text-[#f8fafc] hover:border-zinc-500 rounded-lg text-xs font-semibold transition cursor-pointer"
              >
            ...
            <div className="flex flex-col items-center justify-center py-12 px-4 border border-dashed border-[#27272a] rounded-xl bg-[#18181b]/30">
              ...
              <div className="flex items-center gap-3 mt-4">
                <button
                  type="button"
                  onClick={handleAddRow}
                  className="px-4 py-2 bg-[#14b8a6] hover:bg-teal-400 text-[#042f2e] font-bold rounded-lg text-xs transition cursor-pointer shadow-lg shadow-teal-500/20"
                >
                    ...
                    <tr key={row.id} className="hover:bg-zinc-900/40 transition-colors">
                      ...
                      <td className="px-4 py-3 text-center">
                        ...
                        >
                          ...
                          <option value="MANTENIMIENTO" className="text-amber-440 bg-zinc-950 font-bold">MANTENIMIENTO</option>
                          <option value="EN REPARACIÓN" className="text-rose-440 bg-zinc-950 font-bold">EN REPARACIÓN</option>
                        </select>
                      </td>
